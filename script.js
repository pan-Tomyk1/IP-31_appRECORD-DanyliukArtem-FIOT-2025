// 🔹 Дані для кожної лабораторної
        const labData = {
            lab_1: {
                theme_and_purpose: `
Тема практичної роботи: ТЕГИ ТА АТРИБУТИ HTML-ДОКУМЕНТА. СТРУКТУРНА РОЗМІТКА. GIT.GITHUB. РОБОТА З РЕПОЗИТОРІЯМИ. ОПИС ЛОГІКИ ВЛАСНОГО WEB-ЗАСТОСУНКУ.

Мета практичної роботи: придбати практичні навички роботи  з GitHub, репозиторіями, HTML-документом, таблицями, , зображеннями, посиланнями, списками, формами Створити шаблон звітного HTML-документом для відображення результатів роботи всіх лабораторних робіт.

Тема розробки: Розробка веб-застосунку «Essentia» для пошуку та створення кулінарних рецептів

Мета розробки:Метою розробки є створення сучасного веб-застосунку, який забезпечує користувачів зручними засобами пошуку, перегляду, збереження та створення кулінарних рецептів. Додаток повинен реалізовувати функціонал автентифікації користувачів, можливість формування особистої бібліотеки рецептів, застосування пошукових фільтрів та збереження результатів.
            Розробка спрямована на:
--дослідження предметної області у сфері кулінарних веб-ресурсів;
--формування вимог до інформаційної системи для роботи з рецептами;
--розробку інтерфейсу, що забезпечує інтуїтивну взаємодію користувача із системою;
--перевірку працездатності та ефективності реалізованих механізмів пошуку і додавання рецептів.
        Таким чином, розроблений веб-застосунок повинен стати інструментом, що поєднує зручність, простоту використання та широкі можливості для організації кулінарних знань як для звичайних користувачів, так і для адміністраторів системи.`,
...
,
                        css: "У цій практичній роботі не передбачена робота з css-файлами",
                        js: "У цій практичній роботі не передбачена робота з js-файлами"
                    }
                },
                main_web_page_link: "https://pan-tomyk1.github.io/IP-31_appWEB-DanyliukArtem-FIOT-2025/",
                code_of_main_page: `<!DOCTYPE html>
<html lang="uk">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  btn.addEventListener("click", () => {
    ...
    leftSection.innerHTML = `
      ...
      <ul class="button_holder">
        <li><button class="info_button" data-info="theme_and_purpose">Тема і мета практичної роботи роботи</button></li>
    ...
    leftSection.querySelectorAll(".info_button").forEach(infoBtn => {
      infoBtn.addEventListener("click", () => {
        ...
        if(key === "theme_and_purpose"){
            previewImages.innerHTML = `
            <button class="button_link" onclick="window.open('https://github.com/pan-Tomyk1/IP-31_appWEB-DanyliukArtem-FIOT-2025', '_blank')">  Посилання на репозиторій головної веб-сторінки  </button>
            <button class="button_link" onclick="window.open('https://pan-tomyk1.github.io/IP-31_appWEB-DanyliukArtem-FIOT-2025/, '_blank')">  Посилання на живу головну веб-сторінку  </button>
            <button class="button_link" onclick="window.open('https://github.com/pan-Tomyk1/IP-31_appRECORD-DanyliukArtem-FIOT-2025', '_blank')">  Посилання на репозиторій звітного html документа </button>
            <button class="button_link" onclick="window.open('https://pan-tomyk1.github.io/IP-31_appRECORD-DanyliukArtem-FIOT-2025/', '_blank')">  Посилання на живу сторінку звітного html документа</button>
            `;
        }
        if (key === "structure_of_document") {
          showerInfo.textContent = labData[labId][key].info;
...
<img src="../IP-31_appRECORD-DanyliukArtem-FIOT-2025/img/form_example.png" alt="form_example_photo">`;
          ...
          showerInfo.textContent = labData[labId][key] || "Немає даних.";
        }
